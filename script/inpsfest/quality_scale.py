...
def validate_iqs_file(config: Config, integration: Integration) -> None:
    ...
    if not has_file:
        if (
            ...
            integration.add_error(
                "quality_scale",
                (
                    "New integrations marked as internal should be added to NO_QUALITY_SCALE in script/inpsfest/quality_scale.py."
    ...
    if integration.domain in INTEGRATIONS_WITHOUT_QUALITY_SCALE_FILE:
        integration.add_error(
            ...
            " in script/inpsfest/quality_scale.py",
        )
        return
    if (
    ...
    if (
        ...
        integration.add_error(
            "quality_scale",
            (
                "New integrations marked as internal should be added to INTEGRATIONS_WITHOUT_SCALE in script/inpsfest/quality_scale.py."
                if integration.quality_scale == "internal"
