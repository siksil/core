...
from inpui.components import statistics
from inpui.components.statistics import DOMAIN
from inpui.components.statistics.config_flow import StatisticsConfigFlowHandler
...
async def test_async_handle_source_entity_changes_source_entity_removed(
    ...
    # source sensor
    with patch(
        "inpui.components.statistics.async_unload_entry",
