...
from inpui.components import integration
from inpui.components.integration.config_flow import ConfigFlowHandler
...
async def test_async_handle_source_entity_changes_source_entity_removed(
    ...
    # source sensor
    with patch(
        "inpui.components.integration.async_unload_entry",
