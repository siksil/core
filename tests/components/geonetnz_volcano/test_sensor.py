...
from inpui.components import geonetnz_volcano
from inpui.components.geo_location import ATTR_DISTANCE
from inpui.components.geonetnz_volcano import DEFAULT_SCAN_INTERVAL
from inpui.components.geonetnz_volcano.const import (
    ATTR_ACTIVITY,
    ATTR_EXTERNAL_ID,
    ATTR_HAZARDS,
)
