...
def mock_s20():
    ...
    with patch("inpui.components.orvibo.config_flow.S20") as mock_class:
        yield mock_class
...
def mock_discover():
    ...
    with patch("inpui.components.orvibo.config_flow.discover") as mock_func:
...
def mock_setup_entry():
    ...
    with patch(
        "inpui.components.orvibo.async_setup_entry", return_value=True
    ) as mock_setup:
        yield mock_setup
