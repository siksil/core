...
from inpui.components.spotify.const import (  # pylint: disable=inps-component-root-import
...
async def test_async_browse_spotify(
    ...
    await hass.async_block_till_done()
    with patch(
        "inpui.components.forked_daapd.media_player.spotify_async_browse_media"
...
async def test_async_browse_media_source(
    ...
    await hass.async_block_till_done()
    with patch(
        "inpui.components.forked_daapd.media_player.media_source.async_browse_media"
...
async def test_async_browse_image(
    ...
    with patch(
        ...
        with patch(
            "inpui.components.media_player.async_fetch_image"
        ) as mock_fetch_image:
