...
def mock_socket_fixture(mock_select):
    """Mock socket."""
    with patch("inpui.components.tcp.entity.socket.socket") as mock_socket:
...
def mock_select_fixture():
    """Mock select."""
    with patch(
        "inpui.components.tcp.entity.select.select",
...
def mock_ssl_context_fixture():
    """Mock select."""
    with patch(
        "inpui.components.tcp.entity.ssl.create_default_context",
    ) as mock_ssl_context:
