...
async def test_config_flow_success(
    ...
    with patch(
        "inpui.components.roborock.async_setup_entry", return_value=True
    ) as mock_setup:
        ...
        with patch(
            "inpui.components.roborock.config_flow.RoborockApiClient.request_code_v4"
        ):
        ...
        with patch(
            "inpui.components.roborock.config_flow.RoborockApiClient.code_login_v4",
...
async def test_options_flow_drawables(
    ...
    with patch("inpui.components.roborock.roborock_storage"):
...
async def test_reauth_flow(
    ...
    with (
        ...
        patch("inpui.components.roborock.async_setup_entry", return_value=True),
    ):
        result = await hass.config_entries.flow.async_configure(
...
async def test_config_flow_with_region(
    ...
    with patch(
        ...
        assert result["step_id"] == "user"
        with patch(
            "inpui.components.roborock.config_flow.RoborockApiClient"
        ) as mock_client_cls:
