...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "inpui.components.gree.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def discovery_fixture():
    ...
    with patch("inpui.components.gree.coordinator.Discovery") as mock:
...
def device_fixture():
    ...
    with patch(
        "inpui.components.gree.coordinator.Device",
